...
from mixins.mixin_search import MixinSearch


class SearchPage(BasePage, MixinSearch):
    ...
    def list_search_recommended_prices(self):
        vendor_codes = self.get_web_elements(self.recommended_vendor_code)
        prices = self.get_web_elements(self.recommended_price)
    ...
    def get_search_recommended_buttons_buy(self):
        return self.get_web_elements(self.recommended_button_blue)

    @property
    def get_search_recommended_buttons_in_cart(self):
        return self.get_web_elements(self.recommended_button_green)

    @property
    def amount_of_search_recommended_buttons_in_cart(self):
        return self.amount_of_elements(self.recommended_button_green)
    ...
    def get_first_offers_in_cart_button(self):
        return self.get_web_elements(self.first_offer_button_green)

    @property
    def amount_first_offers_button_in_cart(self):
        return self.amount_of_elements(self.first_offer_button_green)
    ...
    def text_recomended_name(self, order):
        return self.get_web_elements(self.recommended_name)[order].text
    ...
    def text_recomended_brand(self, order):
        return self.get_web_elements(self.recommended_brand)[order].text
    ...
    def text_recomended_vendor_code(self, order):
        return self.get_web_elements(self.recommended_vendor_code)[order].text
    ...
    def text_recomended_delivery(self, order):
        return self.get_web_elements(self.recommended_delivery)[order].text.lower()
    ...
    def text_recomended_price(self, order):
        return self.get_web_elements(self.recommended_price)[order].text
